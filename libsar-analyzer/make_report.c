    ...
    if ( SAR_OPTION == 'Z' )
    {
        ...
        for ( i = 0, ii = -1; i <= MAX_CORE_NUMBERS; i++, ii++ )
        {
            ...
            for ( j = 0; j < files_n; j++ )
            {
                ...
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of '%%sys(%%system)' for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_spike_val_each_file ( j, i, "sys", "spike" ), get_cpu_spike_date_each_file ( j, i, "sys", "spike" ), get_cpu_spike_time_each_file ( j, i, "sys", "spike" ) );
                append_list ( &report_cpu_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of '%%iowait'       for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_spike_val_each_file ( j, i, "iowait", "spike" ), get_cpu_spike_date_each_file ( j, i, "iowait", "spike" ), get_cpu_spike_time_each_file ( j, i, "iowait", "spike" ) );
                append_list ( &report_cpu_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of '%%idle'         for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_spike_val_each_file ( j, i, "idle", "spike" ), get_cpu_spike_date_each_file ( j, i, "idle", "spike" ), get_cpu_spike_time_each_file ( j, i, "idle", "spike" ) );
                append_list ( &report_cpu_spike_obj [ i ], str_tmp );
                append_list ( &report_cpu_spike_obj [ i ], "" );

                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of '%%usr(%%user)'   for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_spike_val_each_file ( j, i, "usr", "highest" ), get_cpu_spike_date_each_file ( j, i, "usr", "highest" ), get_cpu_spike_time_each_file ( j, i, "usr", "highest" ) );
                append_list ( &report_cpu_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of '%%sys(%%system)' for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_spike_val_each_file ( j, i, "sys", "highest" ), get_cpu_spike_date_each_file ( j, i, "sys", "highest" ), get_cpu_spike_time_each_file ( j, i, "sys", "highest" ) );
                append_list ( &report_cpu_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of '%%iowait'       for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_spike_val_each_file ( j, i, "iowait", "highest" ), get_cpu_spike_date_each_file ( j, i, "iowait", "highest" ), get_cpu_spike_time_each_file ( j, i, "iowait", "highest" ) );
                append_list ( &report_cpu_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of '%%idle'         for CPU %s is %8.2f (%s %s)",
                ...
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  time-spanxxx Spike   value of '%%usr(%%user)'   for CPU %s is %8.2f (%s %s)",
                ...
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  time-spanxxx Spike   value of '%%sys(%%system)' for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_time_span_spike_val_each_file ( j, i, "sys", "spike" ), get_cpu_time_span_spike_date_each_file ( j, i, "sys", "spike" ), get_cpu_time_span_spike_time_each_file ( j, i, "sys", "spike" ) );
                append_list ( &report_cpu_time_span_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  time-spanxxx Spike   value of '%%iowait'       for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_time_span_spike_val_each_file ( j, i, "iowait", "spike" ), get_cpu_time_span_spike_date_each_file ( j, i, "iowait", "spike" ), get_cpu_time_span_spike_time_each_file ( j, i, "iowait", "spike" ) );
                append_list ( &report_cpu_time_span_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  time-spanxxx Spike   value of '%%idle'         for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_time_span_spike_val_each_file ( j, i, "idle", "spike" ), get_cpu_time_span_spike_date_each_file ( j, i, "idle", "spike" ), get_cpu_time_span_spike_time_each_file ( j, i, "idle", "spike" ) );
                append_list ( &report_cpu_time_span_spike_obj [ i ], str_tmp );
                append_list ( &report_cpu_time_span_spike_obj [ i ], "" );

                snprintf ( str_tmp, MAX_LINE_LENGTH, "  time-spanxxx Highest value of '%%usr(%%user)'   for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_time_span_spike_val_each_file ( j, i, "usr", "highest" ), get_cpu_time_span_spike_date_each_file ( j, i, "usr", "highest" ), get_cpu_time_span_spike_time_each_file ( j, i, "usr", "highest" ) );
                append_list ( &report_cpu_time_span_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  time-spanxxx Highest value of '%%sys(%%system)' for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_time_span_spike_val_each_file ( j, i, "sys", "highest" ), get_cpu_time_span_spike_date_each_file ( j, i, "sys", "highest" ), get_cpu_time_span_spike_time_each_file ( j, i, "sys", "highest" ) );
                append_list ( &report_cpu_time_span_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  time-spanxxx Highest value of '%%iowait'       for CPU %s is %8.2f (%s %s)",
                    s, get_cpu_time_span_spike_val_each_file ( j, i, "iowait", "highest" ), get_cpu_time_span_spike_date_each_file ( j, i, "iowait", "highest" ), get_cpu_time_span_spike_time_each_file ( j, i, "iowait", "highest" ) );
                append_list ( &report_cpu_time_span_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  time-spanxxx Highest value of '%%idle'         for CPU %s is %8.2f (%s %s)",
        ...
        for ( j = 0; j < files_n; j++ )
        {
            ...
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'proc/s'  is %13.2f (%s %s)",
                get_tasks_spike_val_each_file ( j, "proc", "spike" ), get_tasks_spike_date_each_file ( j, "proc", "spike" ), get_tasks_spike_time_each_file ( j, "proc", "spike" ) );
            append_list ( &report_tasks_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'cswch/s' is %13.2f (%s %s)",
                get_tasks_spike_val_each_file ( j, "cswch", "spike" ), get_tasks_spike_date_each_file ( j, "cswch", "spike" ), get_tasks_spike_time_each_file ( j, "cswch", "spike" ) );
            append_list ( &report_tasks_spike_obj, str_tmp );
            append_list ( &report_tasks_spike_obj, "" );

            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'proc/s'  is %13.2f (%s %s)",
                get_tasks_spike_val_each_file ( j, "proc", "highest" ), get_tasks_spike_date_each_file ( j, "proc", "highest" ), get_tasks_spike_time_each_file ( j, "proc", "highest" ) );
            append_list ( &report_tasks_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'cswch/s' is %13.2f (%s %s)",
        ...
        for ( j = 0; j < files_n; j++ )
        {
            ...
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'pswpin/s'   is %13.2f (%s %s)",
                get_pswap_spike_val_each_file ( j, "pswpin", "spike" ), get_pswap_spike_date_each_file ( j, "pswpin", "spike" ), get_pswap_spike_time_each_file ( j, "pswpin", "spike" ) );
            append_list ( &report_pswap_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'pswpout/s'  is %13.2f (%s %s)",
                get_pswap_spike_val_each_file ( j, "pswpout", "spike" ), get_pswap_spike_date_each_file ( j, "pswpout", "spike" ), get_pswap_spike_time_each_file ( j, "pswpout", "spike" ) );
            append_list ( &report_pswap_spike_obj, str_tmp );
            append_list ( &report_pswap_spike_obj, "" );

            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'pswpin/s'   is %13.2f (%s %s)",
                get_pswap_spike_val_each_file ( j, "pswpin", "highest" ), get_pswap_spike_date_each_file ( j, "pswpin", "highest" ), get_pswap_spike_time_each_file ( j, "pswpin", "highest" ) );
            append_list ( &report_pswap_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'pswpout/s'  is %13.2f (%s %s)",
        ...
        for ( j = 0; j < files_n; j++ )
        {
            ...
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'pgpgin/s'  is %13.2f (%s %s)",
                get_paging_spike_val_each_file ( j, "pgpgin", "spike" ), get_paging_spike_date_each_file ( j, "pgpgin", "spike" ), get_paging_spike_time_each_file ( j, "pgpgin", "spike" ) );
            append_list ( &report_paging_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'pgpgout/s' is %13.2f (%s %s)",
                get_paging_spike_val_each_file ( j, "pgpgout", "spike" ), get_paging_spike_date_each_file ( j, "pgpgout", "spike" ), get_paging_spike_time_each_file ( j, "pgpgout", "spike" ) );
            append_list ( &report_paging_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'fault/s'   is %13.2f (%s %s)",
                get_paging_spike_val_each_file ( j, "fault", "spike" ), get_paging_spike_date_each_file ( j, "fault", "spike" ), get_paging_spike_time_each_file ( j, "fault", "spike" ) );
            append_list ( &report_paging_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'majflt/s'  is %13.2f (%s %s)",
                get_paging_spike_val_each_file ( j, "majflt", "spike" ), get_paging_spike_date_each_file ( j, "majflt", "spike" ), get_paging_spike_time_each_file ( j, "majflt", "spike" ) );
            append_list ( &report_paging_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of '%%vmeff/s'  is %13.2f (%s %s)",
                get_paging_spike_val_each_file ( j, "vmeff", "spike" ), get_paging_spike_date_each_file ( j, "vmeff", "spike" ), get_paging_spike_time_each_file ( j, "vmeff", "spike" ) );
            append_list ( &report_paging_spike_obj, str_tmp );
            append_list ( &report_paging_spike_obj, "" );

            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'pgpgin/s'  is %13.2f (%s %s)",
                get_paging_spike_val_each_file ( j, "pgpgin", "highest" ), get_paging_spike_date_each_file ( j, "pgpgin", "highest" ), get_paging_spike_time_each_file ( j, "pgpgin", "highest" ) );
            append_list ( &report_paging_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'pgpgout/s' is %13.2f (%s %s)",
                get_paging_spike_val_each_file ( j, "pgpgout", "highest" ), get_paging_spike_date_each_file ( j, "pgpgout", "highest" ), get_paging_spike_time_each_file ( j, "pgpgout", "highest" ) );
            append_list ( &report_paging_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'fault/s'   is %13.2f (%s %s)",
                get_paging_spike_val_each_file ( j, "fault", "highest" ), get_paging_spike_date_each_file ( j, "fault", "highest" ), get_paging_spike_time_each_file ( j, "fault", "highest" ) );
            append_list ( &report_paging_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'majflt/s'  is %13.2f (%s %s)",
                get_paging_spike_val_each_file ( j, "majflt", "highest" ), get_paging_spike_date_each_file ( j, "majflt", "highest" ), get_paging_spike_time_each_file ( j, "majflt", "highest" ) );
            append_list ( &report_paging_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of '%%vmeff/s'  is %13.2f (%s %s)",
        ...
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'tps'     is %13.2f (%s %s)",
            get_io_transfer_rate_highest_val ( "tps" ), get_io_transfer_rate_highest_date ( "tps" ), get_io_transfer_rate_highest_time ( "tps" ) );
        append_list ( &report_io_transfer_rate_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'tps'     is %13.2f (%s %s)",
            get_io_transfer_rate_lowest_val ( "tps" ), get_io_transfer_rate_lowest_date ( "tps" ), get_io_transfer_rate_lowest_time ( "tps" ) );
        append_list ( &report_io_transfer_rate_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'tps'     is %13.2f (%s %s)",
            get_io_transfer_rate_spike_val ( "tps" ), get_io_transfer_rate_spike_date ( "tps" ), get_io_transfer_rate_spike_time ( "tps" ) );
        append_list ( &report_io_transfer_rate_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'bread/s' is %13.2f (%s %s)",
            get_io_transfer_rate_highest_val ( "bread" ), get_io_transfer_rate_highest_date ( "bread" ), get_io_transfer_rate_highest_time ( "bread" ) );
        append_list ( &report_io_transfer_rate_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'bread/s' is %13.2f (%s %s)",
            get_io_transfer_rate_lowest_val ( "bread" ), get_io_transfer_rate_lowest_date ( "bread" ), get_io_transfer_rate_lowest_time ( "bread" ) );
        append_list ( &report_io_transfer_rate_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'bread/s' is %13.2f (%s %s)",
            get_io_transfer_rate_spike_val ( "bread" ), get_io_transfer_rate_spike_date ( "bread" ), get_io_transfer_rate_spike_time ( "bread" ) );
        append_list ( &report_io_transfer_rate_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'bwrtn/s' is %13.2f (%s %s)",
            get_io_transfer_rate_highest_val ( "bwrtn" ), get_io_transfer_rate_highest_date ( "bwrtn" ), get_io_transfer_rate_highest_time ( "bwrtn" ) );
        append_list ( &report_io_transfer_rate_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'bwrtn/s' is %13.2f (%s %s)",
            get_io_transfer_rate_lowest_val ( "bwrtn" ), get_io_transfer_rate_lowest_date ( "bwrtn" ), get_io_transfer_rate_lowest_time ( "bwrtn" ) );
        append_list ( &report_io_transfer_rate_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'bwrtn/s' is %13.2f (%s %s)",
            get_io_transfer_rate_spike_val ( "bwrtn" ), get_io_transfer_rate_spike_date ( "bwrtn" ), get_io_transfer_rate_spike_time ( "bwrtn" ) );
        append_list ( &report_io_transfer_rate_obj, str_tmp );
        /* averages */
        append_list ( &report_io_transfer_rate_obj, "" );
        ...
        for ( j = 0; j < files_n; j++ )
        {
            ...
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'tps'     is %13.2f (%s %s)",
                get_io_transfer_rate_spike_val_each_file ( j, "tps", "spike" ), get_io_transfer_rate_spike_date_each_file ( j, "tps", "spike" ), get_io_transfer_rate_spike_time_each_file ( j, "tps", "spike" ) );
            append_list ( &report_io_transfer_rate_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'bread/s' is %13.2f (%s %s)",
                get_io_transfer_rate_spike_val_each_file ( j, "bread", "spike" ), get_io_transfer_rate_spike_date_each_file ( j, "bread", "spike" ), get_io_transfer_rate_spike_time_each_file ( j, "bread", "spike" ) );
            append_list ( &report_io_transfer_rate_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'bwrtn/s' is %13.2f (%s %s)",
                get_io_transfer_rate_spike_val_each_file ( j, "bwrtn", "spike" ), get_io_transfer_rate_spike_date_each_file ( j, "bwrtn", "spike" ), get_io_transfer_rate_spike_time_each_file ( j, "bwrtn", "spike" ) );
            append_list ( &report_io_transfer_rate_spike_obj, str_tmp );
            append_list ( &report_io_transfer_rate_spike_obj, "" );

            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'tps'     is %13.2f (%s %s)",
                get_io_transfer_rate_spike_val_each_file ( j, "tps", "highest" ), get_io_transfer_rate_spike_date_each_file ( j, "tps", "highest" ), get_io_transfer_rate_spike_time_each_file ( j, "tps", "highest" ) );
            append_list ( &report_io_transfer_rate_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'bread/s' is %13.2f (%s %s)",
                get_io_transfer_rate_spike_val_each_file ( j, "bread", "highest" ), get_io_transfer_rate_spike_date_each_file ( j, "bread", "highest" ), get_io_transfer_rate_spike_time_each_file ( j, "bread", "highest" ) );
            append_list ( &report_io_transfer_rate_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'bwrtn/s' is %13.2f (%s %s)",
        ...
        for ( j = 0; j < files_n; j++ )
        {
            ...
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of '%%memused' is %13.2f (%s %s)",
                get_memory_spike_val_each_file ( j, "memused", "spike" ), get_memory_spike_date_each_file ( j, "memused", "spike" ), get_memory_spike_time_each_file ( j, "memused", "spike" ) );
            append_list ( &report_memory_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'kbcommit' is %13d (%s %s)",
                (int)get_memory_spike_val_each_file ( j, "kbcommit", "spike" ), get_memory_spike_date_each_file ( j, "kbcommit", "spike" ), get_memory_spike_time_each_file ( j, "kbcommit", "spike" ) );
            append_list ( &report_memory_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of '%%commit'  is %13.2f (%s %s)",
                get_memory_spike_val_each_file ( j, "commit", "spike" ), get_memory_spike_date_each_file ( j, "commit", "spike" ), get_memory_spike_time_each_file ( j, "commit", "spike" ) );
            append_list ( &report_memory_spike_obj, str_tmp );
            append_list ( &report_memory_spike_obj, "" );

            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of '%%memused' is %13.2f (%s %s)",
                get_memory_spike_val_each_file ( j, "memused", "highest" ), get_memory_spike_date_each_file ( j, "memused", "highest" ), get_memory_spike_time_each_file ( j, "memused", "highest" ) );
            append_list ( &report_memory_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'kbcommit' is %13d (%s %s)",
                (int)get_memory_spike_val_each_file ( j, "kbcommit", "highest" ), get_memory_spike_date_each_file ( j, "kbcommit", "highest" ), get_memory_spike_time_each_file ( j, "kbcommit", "highest" ) );
            append_list ( &report_memory_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of '%%commit'  is %13.2f (%s %s)",
        ...
        for ( j = 0; j < files_n; j++ )
        {
            ...
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of '%%swpused'  is %13.2f (%s %s)",
                get_swpused_spike_val_each_file ( j, "spike" ), get_swpused_spike_date_each_file ( j, "spike" ), get_swpused_spike_time_each_file ( j, "spike" ) );
        ...
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'dentunusd'  is %13d (%s %s)",
            get_kernel_table_highest_val ( "dentunusd" ), get_kernel_table_highest_date ( "dentunusd" ), get_kernel_table_highest_time ( "dentunusd" ) );
        append_list ( &report_kernel_table_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'dentunusd'  is %13d (%s %s)",
            get_kernel_table_lowest_val ( "dentunusd" ), get_kernel_table_lowest_date ( "dentunusd" ), get_kernel_table_lowest_time ( "dentunusd" ) );
        append_list ( &report_kernel_table_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'dentunusd'  is %13d (%s %s)",
            get_kernel_table_spike_val ( "dentunusd" ), get_kernel_table_spike_date ( "dentunusd" ), get_kernel_table_spike_time ( "dentunusd" ) );
        append_list ( &report_kernel_table_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'file-nr'    is %13d (%s %s)",
            get_kernel_table_highest_val ( "file" ), get_kernel_table_highest_date ( "file" ), get_kernel_table_highest_time ( "file" ) );
        append_list ( &report_kernel_table_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'file-nr'    is %13d (%s %s)",
            get_kernel_table_lowest_val ( "file" ), get_kernel_table_lowest_date ( "file" ), get_kernel_table_lowest_time ( "file" ) );
        append_list ( &report_kernel_table_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'file-nr'    is %13d (%s %s)",
            get_kernel_table_spike_val ( "file" ), get_kernel_table_spike_date ( "file" ), get_kernel_table_spike_time ( "file" ) );
        append_list ( &report_kernel_table_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'inode-nr'   is %13d (%s %s)",
            get_kernel_table_highest_val ( "inode" ), get_kernel_table_highest_date ( "inode" ), get_kernel_table_highest_time ( "inode" ) );
        append_list ( &report_kernel_table_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'inode-nr'   is %13d (%s %s)",
            get_kernel_table_lowest_val ( "inode" ), get_kernel_table_lowest_date ( "inode" ), get_kernel_table_lowest_time ( "inode" ) );
        append_list ( &report_kernel_table_obj, str_tmp );
        snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'inode-nr'   is %13d (%s %s)",
            get_kernel_table_spike_val ( "inode"), get_kernel_table_spike_date ( "inode" ), get_kernel_table_spike_time ( "inode" ) );
        append_list ( &report_kernel_table_obj, str_tmp );
        /* averages */
        append_list ( &report_kernel_table_obj, "" );
        ...
        for ( j = 0; j < files_n; j++ )
        {
            ...
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'file-nr'    is %13d (%s %s)",
                get_kernel_table_spike_val_each_file ( j, "file", "spike" ), get_kernel_table_spike_date_each_file ( j, "file", "spike" ), get_kernel_table_spike_time_each_file ( j, "file", "spike" ) );
            append_list ( &report_kernel_table_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'inode-nr'   is %13d (%s %s)",
                get_kernel_table_spike_val_each_file ( j, "inode", "spike" ), get_kernel_table_spike_date_each_file ( j, "inode", "spike" ), get_kernel_table_spike_time_each_file ( j, "inode", "spike" ) );
            append_list ( &report_kernel_table_spike_obj, str_tmp );
            append_list ( &report_kernel_table_spike_obj, "" );

            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'dentunusd'  is %13d (%s %s)",
                get_kernel_table_spike_val_each_file ( j, "dentunusd", "highest" ), get_kernel_table_spike_date_each_file ( j, "dentunusd", "highest" ), get_kernel_table_spike_time_each_file ( j, "dentunusd", "highest" ) );
            append_list ( &report_kernel_table_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'file-nr'    is %13d (%s %s)",
                get_kernel_table_spike_val_each_file ( j, "file", "highest" ), get_kernel_table_spike_date_each_file ( j, "file", "highest" ), get_kernel_table_spike_time_each_file ( j, "file", "highest" ) );
            append_list ( &report_kernel_table_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'inode-nr'   is %13d (%s %s)",
        ...
        for ( j = 0; j < files_n; j++ )
        {
            ...
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'runq-sz'  is %13d (%s %s)",
                (int)get_ldavg_spike_val_each_file ( j, "runq_sz", "spike" ), get_ldavg_spike_date_each_file ( j, "runq_sz", "spike" ), get_ldavg_spike_time_each_file ( j, "runq_sz", "spike" ) );
            append_list ( &report_ldavg_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'plist-sz' is %13d (%s %s)",
                (int)get_ldavg_spike_val_each_file ( j, "plist_sz", "spike" ), get_ldavg_spike_date_each_file ( j, "plist_sz", "spike" ), get_ldavg_spike_time_each_file ( j, "plist_sz", "spike" ) );
            append_list ( &report_ldavg_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'ldavg-1'  is %13.2f (%s %s)",
                get_ldavg_spike_val_each_file ( j, "ldavg_one", "spike" ), get_ldavg_spike_date_each_file ( j, "ldavg_one", "spike" ), get_ldavg_spike_time_each_file ( j, "ldavg_one", "spike" ) );
            append_list ( &report_ldavg_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'ldavg-5'  is %13.2f (%s %s)",
                get_ldavg_spike_val_each_file ( j, "ldavg_five", "spike" ), get_ldavg_spike_date_each_file ( j, "ldavg_five", "spike" ), get_ldavg_spike_time_each_file ( j, "ldavg_five", "spike" ) );
            append_list ( &report_ldavg_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  SPike   value of 'ldavg-15' is %13.2f (%s %s)",
                get_ldavg_spike_val_each_file ( j, "ldavg_15", "spike" ), get_ldavg_spike_date_each_file ( j, "ldavg_15", "spike" ), get_ldavg_spike_time_each_file ( j, "ldavg_15", "spike" ) );
            append_list ( &report_ldavg_spike_obj, str_tmp );
            append_list ( &report_ldavg_spike_obj, "" );

            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'runq-sz'  is %13d (%s %s)",
                (int)get_ldavg_spike_val_each_file ( j, "runq_sz", "highest" ), get_ldavg_spike_date_each_file ( j, "runq_sz", "highest" ), get_ldavg_spike_time_each_file ( j, "runq_sz", "highest" ) );
            append_list ( &report_ldavg_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'plist-sz' is %13d (%s %s)",
                (int)get_ldavg_spike_val_each_file ( j, "plist_sz", "highest" ), get_ldavg_spike_date_each_file ( j, "plist_sz", "highest" ), get_ldavg_spike_time_each_file ( j, "plist_sz", "highest" ) );
            append_list ( &report_ldavg_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'ldavg-1'  is %13.2f (%s %s)",
                get_ldavg_spike_val_each_file ( j, "ldavg_one", "highest" ), get_ldavg_spike_date_each_file ( j, "ldavg_one", "highest" ), get_ldavg_spike_time_each_file ( j, "ldavg_one", "highest" ) );
            append_list ( &report_ldavg_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'ldavg-5'  is %13.2f (%s %s)",
                get_ldavg_spike_val_each_file ( j, "ldavg_five", "highest" ), get_ldavg_spike_date_each_file ( j, "ldavg_five", "highest" ), get_ldavg_spike_time_each_file ( j, "ldavg_five", "highest" ) );
            append_list ( &report_ldavg_spike_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'ldavg-15' is %13.2f (%s %s)",
        ...
        for ( i = 1; i <= MAX_BLOCK_DEVICE_NUMBERS; i++ )
        {
            ...
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'areq-sz' of %s is%s%13.2f (%s %s)"
                , get_block_device_names ( i ), ss, get_block_device_highest_val ( i, "areqsz" ), get_block_device_highest_date ( i, "areqsz" ), get_block_device_highest_time ( i, "areqsz" ) );
            append_list ( &report_block_device_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'areq-sz' of %s is%s%13.2f (%s %s)"
                , get_block_device_names ( i ), ss, get_block_device_lowest_val ( i, "areqsz" ), get_block_device_lowest_date ( i, "areqsz" ), get_block_device_lowest_time ( i, "areqsz" ) );
            append_list ( &report_block_device_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'areq-sz' of %s is%s%13.2f (%s %s)"
                , get_block_device_names ( i ), ss, get_block_device_spike_val ( i, "areqsz" ), get_block_device_spike_date ( i, "areqsz" ), get_block_device_spike_time ( i, "areqsz" ) );
            append_list ( &report_block_device_obj, str_tmp );
            append_list ( &report_block_device_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of '%%util'   of %s is%s%13.2f (%s %s)"
                , get_block_device_names ( i ), ss, get_block_device_highest_val ( i, "util" ), get_block_device_highest_date ( i, "util" ), get_block_device_highest_time ( i, "util" ) );
            append_list ( &report_block_device_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of '%%util'   of %s is%s%13.2f (%s %s)"
                , get_block_device_names ( i ), ss, get_block_device_lowest_val ( i, "util" ), get_block_device_lowest_date ( i, "util" ), get_block_device_lowest_time ( i, "util" ) );
            append_list ( &report_block_device_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of '%%util'   of %s is%s%13.2f (%s %s)"
                , get_block_device_names ( i ), ss, get_block_device_spike_val ( i, "util" ), get_block_device_spike_date ( i, "util" ), get_block_device_spike_time ( i, "util" ) );
            append_list ( &report_block_device_obj, str_tmp );
            append_list ( &report_block_device_obj, "----" );
            /* averages */
            append_list ( &report_ldavg_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest Average value of 'areq-sz' of %s is%s%13.2f (%s)"
                , get_block_device_names ( i ), ss, get_block_device_avg_highest_val ( i, "areqsz" ), get_block_device_avg_highest_date ( i, "areqsz" ) );
            append_list ( &report_block_device_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  Average value of 'areq-sz' of %s is%s%13.2f (%s)"
                , get_block_device_names ( i ), ss, get_block_device_avg_lowest_val ( i, "areqsz" ), get_block_device_avg_lowest_date ( i, "areqsz" ) );
            append_list ( &report_block_device_obj, str_tmp );
            append_list ( &report_block_device_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest Average value of '%%util'   of %s is%s%13.2f (%s)"
                , get_block_device_names ( i ), ss, get_block_device_avg_highest_val ( i, "util" ), get_block_device_avg_highest_date ( i, "util" ) );
            append_list ( &report_block_device_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  Average value of '%%util'   of %s is%s%13.2f (%s)"
                , get_block_device_names ( i ), ss, get_block_device_avg_lowest_val ( i, "util" ), get_block_device_avg_lowest_date ( i, "util" ) );
            append_list ( &report_block_device_obj, str_tmp );
            append_list ( &report_block_device_obj, "----" );
            /* end averages */
        }
        ...
        for ( i = 1; i <= MAX_BLOCK_DEVICE_NUMBERS; i++ )
        {
            ...
            for ( j = 0; j < files_n; j++ )
            {
                ...
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'areq-sz' of %s is%s%13.2f (%s %s)"
                    , get_block_device_names ( i ), ss, get_block_device_spike_val_each_file ( j, i, "areqsz", "spike" ), get_block_device_spike_date_each_file ( j, i, "areqsz", "spike" ), get_block_device_spike_time_each_file ( j, i, "areqsz", "spike" ) );
                append_list ( &report_block_device_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of '%%util'   of %s is%s%13.2f (%s %s)"
                    , get_block_device_names ( i ), ss, get_block_device_spike_val_each_file ( j, i, "util", "spike" ), get_block_device_spike_date_each_file ( j, i, "util", "spike" ), get_block_device_spike_time_each_file ( j, i, "util", "spike" ) );
                append_list ( &report_block_device_spike_obj [ i ], str_tmp );
                append_list ( &report_block_device_spike_obj [ i ], "" );

                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'areq-sz' of %s is%s%13.2f (%s %s)"
                    , get_block_device_names ( i ), ss, get_block_device_spike_val_each_file ( j, i, "areqsz", "highest" ), get_block_device_spike_date_each_file ( j, i, "areqsz", "highest" ), get_block_device_spike_time_each_file ( j, i, "areqsz", "highest" ) );
                append_list ( &report_block_device_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of '%%util'   of %s is%s%13.2f (%s %s)"
        ...
        for ( i = 1; i <= MAX_NETWORK_DEVICE_NUMBERS; i++ )
        {
            ...
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'rxpck/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_highest_val ( i, "rxpck" ), get_network_highest_date ( i, "rxpck" ), get_network_highest_time ( i, "rxpck" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'rxpck/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_lowest_val ( i, "rxpck" ), get_network_lowest_date ( i, "rxpck" ), get_network_lowest_time ( i, "rxpck" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'rxpck/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_spike_val ( i, "rxpck" ), get_network_spike_date ( i, "rxpck" ), get_network_spike_time ( i, "rxpck" ) );
            append_list ( &report_network_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'txpck/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_highest_val ( i, "txpck" ), get_network_highest_date ( i, "txpck" ), get_network_highest_time ( i, "txpck" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'txpck/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_lowest_val ( i, "txpck" ), get_network_lowest_date ( i, "txpck" ), get_network_lowest_time ( i, "txpck" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'txpck/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_spike_val ( i, "txpck" ), get_network_spike_date ( i, "txpck" ), get_network_spike_time ( i, "txpck" ) );
            append_list ( &report_network_obj, str_tmp );
            append_list ( &report_network_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'rxkB/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_highest_val ( i, "rxkb" ), get_network_highest_date ( i, "rxkb" ), get_network_highest_time ( i, "rxkb" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'rxkB/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_lowest_val ( i, "rxkb" ), get_network_lowest_date ( i, "rxkb" ), get_network_lowest_time ( i, "rxkb" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'rxkB/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_spike_val ( i, "rxkb" ), get_network_spike_date ( i, "rxkb" ), get_network_spike_time ( i, "rxkb" ) );
            append_list ( &report_network_obj, str_tmp );
            append_list ( &report_network_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'txkB/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_highest_val ( i, "txkb" ), get_network_highest_date ( i, "txkb" ), get_network_highest_time ( i, "txkb" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'txkB/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_lowest_val ( i, "txkb" ), get_network_lowest_date ( i, "txkb" ), get_network_lowest_time ( i, "txkb" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'txkB/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_spike_val ( i, "txkb" ), get_network_spike_date ( i, "txkb" ), get_network_spike_time ( i, "txkb" ) );
            append_list ( &report_network_obj, str_tmp );
            append_list ( &report_network_obj, "----" );
            /* averages */
            append_list ( &report_network_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest Average value of 'rxpck/s' of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_highest_val ( i, "rxpck" ), get_network_avg_highest_date ( i, "rxpck" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  Average value of 'rxpck/s' of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_lowest_val ( i, "rxpck" ), get_network_avg_lowest_date ( i, "rxpck" ) );
            append_list ( &report_network_obj, str_tmp );
            append_list ( &report_network_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest Average value of 'txpck/s' of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_highest_val ( i, "txpck" ), get_network_avg_highest_date ( i, "txpck" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  Average value of 'txpck/s' of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_lowest_val ( i, "txpck" ), get_network_avg_lowest_date ( i, "txpck" ) );
            append_list ( &report_network_obj, str_tmp );
            append_list ( &report_network_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest Average value of 'rxkB/s'  of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_highest_val ( i, "rxkb" ), get_network_avg_highest_date ( i, "rxkb" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  Average value of 'rxkB/s'  of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_lowest_val ( i, "rxkb" ), get_network_avg_lowest_date ( i, "rxkb" ) );
            append_list ( &report_network_obj, str_tmp );
            append_list ( &report_network_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest Average value of 'txkB/s'  of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_highest_val ( i, "txkb" ), get_network_avg_highest_date ( i, "txkb" ) );
            append_list ( &report_network_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  Average value of 'txkB/s'  of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_lowest_val ( i, "txkb" ), get_network_avg_lowest_date ( i, "txkb" ) );
            append_list ( &report_network_obj, str_tmp );
            append_list ( &report_network_obj, "----" );
            /* end averages */
        }
        ...
        for ( i = 1; i <= MAX_NETWORK_DEVICE_NUMBERS; i++ )
        {
            ...
            for ( j = 0; j < files_n; j++ )
            {
                ...
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'rxpck/s' of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "rxpck", "spike" ), get_network_spike_date_each_file ( j, i, "rxpck", "spike" ), get_network_spike_time_each_file ( j, i, "rxpck", "spike" ) );
                append_list ( &report_network_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'txpck/s' of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "txpck", "spike" ), get_network_spike_date_each_file ( j, i, "txpck", "spike" ), get_network_spike_time_each_file ( j, i, "txpck", "spike" ) );
                append_list ( &report_network_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'rxkB/s'  of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "rxkb", "spike" ), get_network_spike_date_each_file ( j, i, "rxkb", "spike" ), get_network_spike_time_each_file ( j, i, "rxkb", "spike" ) );
                append_list ( &report_network_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'txkB/s'  of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "txkb", "spike" ), get_network_spike_date_each_file ( j, i, "txkb", "spike" ), get_network_spike_time_each_file ( j, i, "txkb", "spike" ) );
                append_list ( &report_network_spike_obj [ i ], str_tmp );
                append_list ( &report_network_spike_obj [ i ], "" );

                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'rxpck/s' of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "rxpck", "highest" ), get_network_spike_date_each_file ( j, i, "rxpck", "highest" ), get_network_spike_time_each_file ( j, i, "rxpck", "highest" ) );
                append_list ( &report_network_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'txpck/s' of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "txpck", "highest" ), get_network_spike_date_each_file ( j, i, "txpck", "highest" ), get_network_spike_time_each_file ( j, i, "txpck", "highest" ) );
                append_list ( &report_network_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'rxkB/s'  of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "rxkb", "highest" ), get_network_spike_date_each_file ( j, i, "rxkb", "highest" ), get_network_spike_time_each_file ( j, i, "rxkb", "highest" ) );
                append_list ( &report_network_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'txkB/s'  of %s is%s%13.2f (%s %s)"
        ...
        for ( i = 1; i <= MAX_NETWORK_DEVICE_NUMBERS; i++ )
        {
            ...
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'rxerr/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_highest_val ( i, "rxerr" ), get_network_highest_date ( i, "rxerr" ), get_network_highest_time ( i, "rxerr" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'rxerr/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_lowest_val ( i, "rxerr" ), get_network_lowest_date ( i, "rxerr" ), get_network_lowest_time ( i, "rxerr" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'rxerr/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_spike_val ( i, "rxerr" ), get_network_spike_date ( i, "rxerr" ), get_network_spike_time ( i, "rxerr" ) );
            append_list ( &report_network_error_obj, str_tmp );
            append_list ( &report_network_error_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'txerr/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_highest_val ( i, "txerr" ), get_network_highest_date ( i, "txerr" ), get_network_highest_time ( i, "txerr" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'txerr/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_lowest_val ( i, "txerr" ), get_network_lowest_date ( i, "txerr" ), get_network_lowest_time ( i, "txerr" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'txerr/s'  of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_spike_val ( i, "txerr" ), get_network_spike_date ( i, "txerr" ), get_network_spike_time ( i, "txerr" ) );
            append_list ( &report_network_error_obj, str_tmp );
            append_list ( &report_network_error_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'rxdrop/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_highest_val ( i, "rxdrop" ), get_network_highest_date ( i, "rxdrop" ), get_network_highest_time ( i, "rxdrop" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'rxdrop/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_lowest_val ( i, "rxdrop" ), get_network_lowest_date ( i, "rxdrop" ), get_network_lowest_time ( i, "rxdrop" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'rxdrop/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_spike_val ( i, "rxdrop" ), get_network_spike_date ( i, "rxdrop" ), get_network_spike_time ( i, "rxdrop" ) );
            append_list ( &report_network_error_obj, str_tmp );
            append_list ( &report_network_error_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest value of 'txdrop/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_highest_val ( i, "txdrop" ), get_network_highest_date ( i, "txdrop" ), get_network_highest_time ( i, "txdrop" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  value of 'txdrop/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_lowest_val ( i, "txdrop" ), get_network_lowest_date ( i, "txdrop" ), get_network_lowest_time ( i, "txdrop" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'txdrop/s' of %s is%s%13.2f (%s %s)"
                , get_network_device_names ( i ), ss, get_network_spike_val ( i, "txdrop" ), get_network_spike_date ( i, "txdrop" ), get_network_spike_time ( i, "txdrop" ) );
            append_list ( &report_network_error_obj, str_tmp );
            /* averages */
            append_list ( &report_network_error_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest Average value of 'rxerr/s'  of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_highest_val ( i, "rxerr" ), get_network_avg_highest_date ( i, "rxerr" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  Average value of 'rxerr/s'  of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_lowest_val ( i, "rxerr" ), get_network_avg_lowest_date ( i, "rxerr" ) );
            append_list ( &report_network_error_obj, str_tmp );
            append_list ( &report_network_error_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest Average value of 'txerr/s'  of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_highest_val ( i, "txerr" ), get_network_avg_highest_date ( i, "txerr" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  Average value of 'txerr/s'  of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_lowest_val ( i, "txerr" ), get_network_avg_lowest_date ( i, "txerr" ) );
            append_list ( &report_network_error_obj, str_tmp );
            append_list ( &report_network_error_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest Average value of 'rxdrop/s' of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_highest_val ( i, "rxdrop" ), get_network_avg_highest_date ( i, "rxdrop" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  Average value of 'rxdrop/s' of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_lowest_val ( i, "rxdrop" ), get_network_avg_lowest_date ( i, "rxdrop" ) );
            append_list ( &report_network_error_obj, str_tmp );
            append_list ( &report_network_error_obj, "" );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Highest Average value of 'txdrop/s' of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_highest_val ( i, "txdrop" ), get_network_avg_highest_date ( i, "txdrop" ) );
            append_list ( &report_network_error_obj, str_tmp );
            snprintf ( str_tmp, MAX_LINE_LENGTH, "  Lowest  Average value of 'txdrop/s' of %s is%s%13.2f (%s)"
                , get_network_device_names ( i ), ss, get_network_avg_lowest_val ( i, "txdrop" ), get_network_avg_lowest_date ( i, "txdrop" ) );
            append_list ( &report_network_error_obj, str_tmp );
            append_list ( &report_network_error_obj, "----" );
            /* end averages */
        }
        ...
        for ( i = 1; i <= MAX_NETWORK_DEVICE_NUMBERS; i++ )
        {
            ...
            for ( j = 0; j < files_n; j++ )
            {
                ...
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'rxerr/s'  of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "rxerr", "spike" ), get_network_spike_date_each_file ( j, i, "rxerr", "spike" ), get_network_spike_time_each_file ( j, i, "rxerr", "spike" ) );
                append_list ( &report_network_error_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'txerr/s'  of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "txerr", "spike" ), get_network_spike_date_each_file ( j, i, "txerr", "spike" ), get_network_spike_time_each_file ( j, i, "txerr", "spike" ) );
                append_list ( &report_network_error_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'rxdrop/s' of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "rxdrop", "spike" ), get_network_spike_date_each_file ( j, i, "rxdrop", "spike" ), get_network_spike_time_each_file ( j, i, "rxdrop", "spike" ) );
                append_list ( &report_network_error_spike_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Spike   value of 'txdrop/s' of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "txdrop", "spike" ), get_network_spike_date_each_file ( j, i, "txdrop", "spike" ), get_network_spike_time_each_file ( j, i, "txdrop", "spike" ) );
                append_list ( &report_network_error_spike_obj [ i ], str_tmp );
        ...
        for ( j = 0; j < files_n; j++ )
        {
            if ( strcmp ( get_network_spike_date_each_file ( j, i, "rxpck", "down" ), "" )  != 0 )
            {
                ...
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Down   time of 'rxpck/s' of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "rxpck", "down" ), get_network_spike_date_each_file ( j, i, "rxpck", "down" ), get_network_spike_time_each_file ( j, i, "rxpck", "down" ) );
                append_list ( &report_network_down_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Down   time of 'txpck/s' of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "txpck", "down" ), get_network_spike_date_each_file ( j, i, "txpck", "down" ), get_network_spike_time_each_file ( j, i, "txpck", "down" ) );
                append_list ( &report_network_down_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Down   time of 'rxkB/s'  of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "rxkb", "down" ), get_network_spike_date_each_file ( j, i, "rxkb", "down" ), get_network_spike_time_each_file ( j, i, "rxkb", "down" ) );
                append_list ( &report_network_down_obj [ i ], str_tmp );
                snprintf ( str_tmp, MAX_LINE_LENGTH, "  Down   time of 'txkB/s'  of %s is%s%13.2f (%s %s)"
                    , get_network_device_names ( i ), ss, get_network_spike_val_each_file ( j, i, "txkb", "down" ), get_network_spike_date_each_file ( j, i, "txkb", "down" ), get_network_spike_time_each_file ( j, i, "txkb", "down" ) );
                append_list ( &report_network_down_obj [ i ], str_tmp );
                l++;
            }
        }
...
int append_labels_to_ps_obj ( node **obj, FILE *fp_w, const char *item )
{
    ...
    if ( strcmp ( "cpu", item ) == 0 )
    {
        ...
        snprintf ( str_tmp, 50, " 45 2000 m (Created by sar-analyzer %d.%d.%d) sh", PROGRAM_VERSION, PROGRAM_RELEASE, PROGRAM_SUB_RELEASE );
